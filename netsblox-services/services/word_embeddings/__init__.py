...
@nb.argument('size', type=types.Int, help='Dimensionality of the word vectors', optional=True)
@nb.argument('window', type=types.Int, help='Max distance between current and predicted word', optional=True)
@nb.argument('minCount', type=types.Int, help='Ignore words with fewer than this number of occurrences', optional=True)
...
@nb.argument('count', type=types.Int, help='Number of words to return', optional=True)
